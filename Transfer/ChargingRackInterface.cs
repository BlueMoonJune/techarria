...
{
	public class ChargingRackInterface : ContainerInterface
    {
        public ChargingRackInterface(int i, int j)
        {
            x = i;
            y = j;
        }
        ...
        public static Point FindTopLeft(int i, int j)
        {
            ...
            if (ModContent.GetModTile(tile.TileType) is ChargingRack)
            {
        ...
        public override List<Item> GetItems()
        {
            ...
            ChargingRackTE tileEntity = TE as ChargingRackTE;
