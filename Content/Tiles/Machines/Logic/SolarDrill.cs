...
{
	internal class SolarDrill : BeamDrill
	{
		...
		public override void SetStaticDefaults() {
			...
			effect = ModContent.Request<Effect>("Techarria/Assets/Effects/SolarBeam", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
