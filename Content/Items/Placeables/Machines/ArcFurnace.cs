...
{
	public class ArcFurnace : ModItem
	{
		...
		public override void SetDefaults() {
			Item.DefaultToPlaceableTile(ModContent.TileType<Tiles.Machines.ArcFurnace>());
			Item.value = 150;
			Item.maxStack = 99;
			Item.width = 28;
			Item.height = 20;
		...
		{
			Recipe recipe = Recipe.Create(ModContent.ItemType<Machines.ArcFurnace>());
